...
#            contours = measure.find_contours(img0, 100)
#            for c in contours:
#                c = np.around(c).astype(np.int)
#                image0[c[:, 0], c[:, 1]] = 1
#            img0 = Image.fromarray(image0)
            
            img1 = PIL.ImageOps.invert(img1)

#            contours1 = measure.find_contours(img1, 100)
#            for c in contours1:
#                c = np.around(c).astype(np.int)
#                image1[c[:, 0], c[:, 1]] = 1
#            img1 = Image.fromarray(image1)
#        p = transforms.Compose([transforms.Resize(105)])
#        img0 = p(img0)
#        img1 = p(img1)
# 
...
#        
  ...
  #      print(batch.shape)
   ...
   #     print(batch.shape)    
        ...
        batch = func.relu(self.conv4(batch))
